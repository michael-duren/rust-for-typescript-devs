...
impl Default for Rect {
    // kind of like accessing the class almost kind of like a constructor
    fn default() -> Self {
        return Rect {
            x: 0.0,
            y: 0.0,
...
// implement a trait for displaying the rectangel
// implementing display also implements .to_string on the struct
